...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/">
    <html>
      ...
      <head>
        <title>Hierarchical Group Expander Component Status - <xsl:value-of select="/status/component/@name"/></title>
      </head>
      <body>
        ...
        <table>
          <tr>
            ...
            <td>
              <h2 style="margin-left:2em">HierarchicalGroupExpander:  <xsl:value-of select="/status/component/@name"/></h2>
            </td>
          </tr>
        </table>
