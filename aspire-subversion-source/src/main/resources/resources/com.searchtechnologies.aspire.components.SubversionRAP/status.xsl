...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/">
    <html>
      ...
      <head>
        <title>FilesystemRAP Component Status - <xsl:value-of select="/status/component/@name"/></title>
      </head>
      <body>
        ...
        <table>
          <tr>
            ...
            <td>
              <h2 style="margin-left:2em">FilesystemRAP:  <xsl:value-of select="/status/component/@name"/></h2>
            </td>
          </tr>
        </table>
